...
1. search for "rules_nushell" and replace with the name you'll use for your workspace
1. search for "TheGrizzlyDev" and replace with GitHub org
1. search for "nushell" and replace with the language/tool your rules are for
1. rename directory "nushell" similarly
