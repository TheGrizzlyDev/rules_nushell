...
# By default all these toolchains are registered by the nushell_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:nushell_toolchain",
    toolchain_type = "@rules_nushell//nushell:toolchain_type",
)
""".format(
            platform = platform,
